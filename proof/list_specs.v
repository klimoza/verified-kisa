...
Definition beside_doc_spec : ident * funspec :=
 DECLARE _beside_doc
  WITH fs1 : list t, fs2 : list t, p1 : val, p2 : val, w : Z, h : Z
  PRE [ tuint, tuint, tptr t_flist, tptr t_flist ]
   ...
   PARAMS(Vint (Int.repr w); Vint (Int.repr h); p1; p2)
    SEP (listrepf fs1 p1; listrepf fs2 p2)
  POST [ tptr t_flist ]
...
Definition Gprog : funspecs :=
        ltac:(with_library prog [
                   ...
                   llw_add_fill_spec; add_fill_spec; beside_doc_spec
 ]).